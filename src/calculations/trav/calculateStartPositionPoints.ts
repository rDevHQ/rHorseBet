import { MAX_CATEGORY_POINTS } from '../../calculations/pointsConfig';
...
export function calculateStartPositionPoints(start: Horse, raceHorses: Horse[], startMethod: string): number {

function getRawScore(method: string, number: number): number {
    if (method === "volte") {

    ...
    horses.forEach((horse, index) => {
        ...
        rowValues.forEach((value, i) => {
            ...
            if (theadRow?.cells[i]?.textContent === "Hästnamn") {
                ...
                let ml_score_threshold_3_upset, ml_score_threshold_2_upset, ml_score_threshold_1_upset;
                if (isGallop) {
                    ml_score_threshold_3_upset = 83;
                    ml_score_threshold_2_upset = 77;
                    ml_score_threshold_1_upset = 70;
                }
                else {
                    ml_score_threshold_3_upset = 85;
                    ml_score_threshold_2_upset = 80;
                    ml_score_threshold_1_upset = 75;
                }

                if (horse.mlUpsetScore.toFixed(0) >= ml_score_threshold_3_upset && horse.bettingPercentagePoints < 60) {
                    inner += ` <span title="Hög skrällpotential (ML Skrällpoäng ${horse.mlUpsetScore.toFixed(0)}, Skrällrank ${horse.mlUpsetRank})">🔥🔥🔥</span>`;
                } else if (horse.mlUpsetScore.toFixed(0) >= ml_score_threshold_2_upset && horse.bettingPercentagePoints < 60) {
                    inner += ` <span title="Hög skrällpotential (ML Skrällpoäng ${horse.mlUpsetScore.toFixed(0)}, Skrällrank ${horse.mlUpsetRank})">🔥🔥</span>`;
                } else if (horse.mlUpsetScore.toFixed(0) >= ml_score_threshold_1_upset && horse.bettingPercentagePoints < 60) {
                    inner += ` <span title="Hög skrällpotential (ML Skrällpoäng ${horse.mlUpsetScore.toFixed(0)}, Skrällrank ${horse.mlUpsetRank})">🔥</span>`;
                }
                ...
                if (isGallop) {
                    ...
                    ml_score_threshold_2_spik = 78.42;
                    ml_score_threshold_1_spik = 70.43;
                }
                ...
                if ((horse.mlRank === 1 || horse.mlRank === 2) && score >= ml_score_threshold_1_spik - 10 && gap12 <= 3 && gap23 >= 10) {
